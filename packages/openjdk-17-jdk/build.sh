...
TERMUX_PKG_DESCRIPTION="OpenJDK 17 Java Runtime Environment (prerelease)"
TERMUX_PKG_VERSION="17.0"
TERMUX_PKG_MAINTAINER="@suhan-paradkar"
TERMUX_PKG_DEPENDS="freetype, gcc-10, libffi, libpng, ca-certificates-java, alsa-lib, libx11, libxext, libxtst, libxt, libxrender"
TERMUX_PKG_SRCURL=https://github.com/openjdk/mobile.git
