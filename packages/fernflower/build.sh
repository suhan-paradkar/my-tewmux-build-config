TERMUX_PKG_DESCRIPTION="Fernglower"
TERMUX_PKG_LICENSE="Apache-2.0"
TERMUX_PKG_VERSION=212
TERMUX_PKG_SRCURL=https://github.com/fesh0r/fernflower.git
...
termux_step_make() {
	...
	$TERMUX_PKG_TMPDIR/gradle/gradle-$_GRADLE_VERSION/bin/gradle \
		:org.jetbrains.java.decompiler.main.decompiler.ConsoleDecompiler:assembleRelease
}

termux_step_make_install() {
	cp $TERMUX_PKG_SRCDIR/fernflower $TERMUX_PREFIX/bin/fernflower
}
